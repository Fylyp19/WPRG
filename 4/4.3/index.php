...
<select id="osoby" type="value" requierd name="osoby">
...
<br/><br/>
<input type="submit" name ="submit" value="wyslij pierwszy form"/>
<br/><br/>
<input type="submit" name ="submit" value="wyslij kolejny form"/>
<br/><br/>
<input type="submit" name ="submit" value="wczytaj"/>
</form>
<body>
</body>
</html>